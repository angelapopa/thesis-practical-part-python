...
def classifyingAndSavingRadiusModels(country, thermalDataQueryFields, dbData):
...
# radius=1.0, *, weights='uniform', algorithm='auto', leaf_size=30, p=2, metric='minkowski',
# outlier_label=None, metric_params=None, n_jobs=None, **kwargs)
