...
sclaerFilename = "serialized_joblib_scaler_england.pck"

here = os.path.dirname(os.path.abspath(__file__))
filepathScaler = os.path.join(here, 'persisted_models/' + sclaerFilename)
...
# joblib - save model to file
filenameRadiusClassifier = "serialized_joblib_radius_classifier_england.pck"

here = os.path.dirname(os.path.abspath(__file__))
filepathRadiusClassifier = os.path.join(
    here, 'persisted_models/'+filenameRadiusClassifier)
