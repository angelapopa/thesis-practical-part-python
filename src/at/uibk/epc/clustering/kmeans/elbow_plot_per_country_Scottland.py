...
def elbow_plot_Scottland():
    ...
    calculate_metrics(slim_data_df, 3, 'Scottland')
    calculate_metrics(slim_data_df, 4, 'Scottland')
    calculate_metrics(slim_data_df, 5, 'Scottland')
    calculate_metrics(slim_data_df, 6, 'Scottland')
    calculate_metrics(slim_data_df, 7, 'Scottland')
    calculate_metrics(slim_data_df, 8, 'Scottland')
    #elbow_plot_fct(slim_data_df, 'Scottland')


elbow_plot_Scottland()
